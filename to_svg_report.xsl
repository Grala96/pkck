...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/2000/svg" xmlns:date="http://exslt.org/dates-and-times" xmlns:svg="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0">
   ...
   <xsl:template match="/">
      <svg:svg font-family="Calibri" overflow="auto">
         ...
         <script type="text/javascript"><![CDATA[function onMouseOverBar(obj) {
                    	var bar=obj.childNodes[0];
                        bar.setAttribute("fill-opacity","1");
                        var text=obj.childNodes[1];
                        text.setAttribute("visibility","visible");
                    }]]></script>
         <script type="text/javascript"><![CDATA[function onMouseOutBar(obj) {
                   		var bar=obj.childNodes[0];
